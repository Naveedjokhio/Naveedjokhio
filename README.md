...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:4facfe,50:00f2fe,100:a18cd1&height=220&section=header&text=Hi%2C%20I'm%20Naveed%20Jokhio%20%F0%9F%91%8B&fontSize=42&fontColor=1a1a2e&fontAlignY=35&desc=Cloud%20Data%20Engineer%20%7C%20Streaming%20%26%20Batch%20Pipelines%20at%20Scale&descAlignY=58&descSize=17&animation=fadeIn" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&pause=1000&color=4FACFE&center=true&vCenter=true&width=650&lines=Final+Year+SE+Student+%40+SMIU%2C+Karachi;Data+Engineer+%40+Saylani+Mass+IT+Training;Data+Science+Intern+%40+10Pearls+Pakistan;Kafka+%7C+PySpark+%7C+dlt+%7C+BigQuery+%7C+Kestra;Open+to+Cloud+Data+Engineer+Roles+%F0%9F%93%A7"/>
...
## 🥉🥈🥇 Bronze → Silver → Gold: My Journey

<div align="center">

| 🥉 Bronze — Raw Input | 🥈 Silver — Refinement | 🥇 Gold — Analytics-Ready |
|:---:|:---:|:---:|
| BS Software Engineering<br>@ SMIU, Karachi (2023–2027) | Kafka · PySpark · dlt · dbt<br>BigQuery · Kestra · Docker | Data Engineer @ Saylani<br>Data Science Intern @ 10Pearls<br>→ Cloud Data Engineer |

</div>

<p align="center"><i>Just like raw events are refined stage by stage into business-ready insight, I'm refining myself into a production-ready Cloud Data Engineer 🚀</i></p>
...
class NaveedJokhio:
    def __init__(self):
        ...
        self.education  = "BS Software Engineering, SMIU, Karachi (2023 - 2027)"
        self.experience = [
            "Data Engineer @ Saylani Mass IT Training",
            "Data Science Intern @ 10Pearls Pakistan",
        ]
        self.stack = [
            "Python", "SQL", "Apache Kafka", "PySpark", "dlt",
            "dbt", "Bruin", "Kestra", "Snowflake", "BigQuery",
            "GCS", "AWS (S3, Glue, Lambda, Athena)", "Airflow",
            "Docker", "Power BI",
        ]
        self.focus = [
            "Real-Time Streaming Pipelines", "Medallion Architecture",
            "ELT/ETL", "Star Schema", "SCD Type-2", "Data Orchestration",
        ]
        self.location = "Karachi, Pakistan 🇵🇰"
        self.open_to  = "Cloud Data Engineering Roles & Collaborations"
...
<img src="https://img.shields.io/badge/Apache_Kafka-0D1117?style=for-the-badge&logo=apachekafka&logoColor=231F20"/>
<img src="https://img.shields.io/badge/PySpark-0D1117?style=for-the-badge&logo=apachespark&logoColor=E25A1C"/>
<img src="https://img.shields.io/badge/dlt-0D1117?style=for-the-badge&color=FF6F00"/>

**Cloud — GCP**<br>
<img src="https://img.shields.io/badge/BigQuery-0D1117?style=for-the-badge&logo=googlebigquery&logoColor=4285F4"/>
<img src="https://img.shields.io/badge/Google_Cloud_Storage-0D1117?style=for-the-badge&logo=googlecloud&logoColor=4285F4"/>
...
<img src="https://img.shields.io/badge/Kestra-0D1117?style=for-the-badge&color=6C3EF4"/>
...
<img src="https://img.shields.io/badge/Bruin-0D1117?style=for-the-badge&color=0D1117"/>
...
<img src="https://img.shields.io/badge/Real--Time_Streaming-F97316?style=for-the-badge&color=F97316"/>
...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:16a085,100:2ecc71&height=4&width=100%25" width="100%"/>

A full GCP-based real-time streaming pipeline delivering live cricket match data end-to-end, with a synthetic match simulator built in as a resilient fallback layer.

- ⚡ **Kafka → GCS → dlt → BigQuery → dbt** medallion flow, orchestrated with **Bruin + Kestra**
- 🐳 Solved real production issues along the way: Docker-in-Docker volume mounting, GCP ADC credential mounting inside Kestra containers, dlt pipeline state corruption, and WSL2 disk space exhaustion
...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:4facfe,100:00f2fe&height=4&width=100%25" width="100%"/>

A production-grade e-commerce data pipeline built as a flagship portfolio piece, combining streaming ingestion with a full cloud-native medallion architecture.

- 🔄 **dlt + Apache Kafka + PySpark** for ingestion and transformation
- ☁️ **GCS → BigQuery** as the cloud data lake and warehouse layer
- 🎛️ Orchestrated with **Bruin** and **Kestra**, fully containerized via **Docker Compose**
- 🖥️ Developed end-to-end on Windows + GCP, targeting production-style reliability and observability

<img src="https://img.shields.io/badge/Apache_Kafka-231F20?style=for-the-badge&logo=apachekafka&logoColor=white"/>
<img src="https://img.shields.io/badge/PySpark-E25A1C?style=for-the-badge&logo=apachespark&logoColor=white"/>
<img src="https://img.shields.io/badge/GCS-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white"/>
<img src="https://img.shields.io/badge/BigQuery-4285F4?style=for-the-badge&logo=googlebigquery&logoColor=white"/>
<img src="https://img.shields.io/badge/Kestra-6C3EF4?style=for-the-badge"/>
...
A production-grade batch pipeline ingesting live flight data from the OpenSky Network API every 30 minutes via an Airflow DAG.
...
An event-driven, serverless ETL pipeline converting raw JSON into columnar Parquet, cutting storage costs by ~40%. Schema inference automated via AWS Glue Crawlers, with modular Lambda functions and S3 partitioning.
...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:8E2DE2,100:4A00E0&height=4&width=100%25" width="100%"/>

A streaming-style pipeline combining PySpark transformations with dbt modeling for analytics-ready outputs.
...
- 🎛️ Working hands-on with orchestration tools (Kestra, Bruin) for production-style pipeline reliability
